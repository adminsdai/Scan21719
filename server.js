...
// Endpoint to scan a URL (Recursive domain crawl)
  ...
  try {
    ...
    res.json({
      ...
      details: {
        ...
        cookies: allCookies,
        securityHeaders: rootHeaders, // Send root headers as baseline
        pageHeadersStatus,            // Send page-by-page header details
        forms: allForms,
